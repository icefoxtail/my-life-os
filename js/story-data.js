...
window.STORY_LIBRARY = [
  ...
  { id:"orig_bed_1", theme:"잠자리", voiceTone:"bedtime", title:"구름 양탄자의 자장가", desc:"하늘을 나는 침대", plotSeed:"시현이 방에 둥실둥실 구름 양탄자가 찾아와 밤하늘로 데려감", conflict:"잠이 오지 않는 밤을 포근하게 만들어줌", sihyeonRole:"시현이가 구름 양탄자에 누워 달님에게 굿나잇 인사를 하고 스르르 잠이 듦", characters:["시현","구름양탄자","달님"], mood:"포근함", readingMinutes:5, hasFullContent:true, storyPackId:"bed_cloud_lullaby" },
...
/* 11페이지 그림책 메타는 js/data/story-pack-registry.js에서 일괄 부여한다. */
if (window.StoryPackRegistry?.prepareStoryLibrary) window.StoryPackRegistry.prepareStoryLibrary();

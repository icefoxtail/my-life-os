...
window.SihyeonGames.letterPlay = {
  ...
  _injectStyle() {
    ...
    style.textContent = `
      ...
      .slp-balloon-btn.wrong .slp-balloon-body { animation: slp-shake 0.4s ease !important; filter: grayscale(0.5); }
  ...
  render(container, options = {}) {
    ...
    wrapper.style.cssText = 'width:100%;height:100%;display:flex;flex-direction:column;overflow:hidden;box-sizing:border-box;';
